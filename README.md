# [roq-kraken-futures](https://roq-trading.com/docs/reference/gateways/crypto/roq-kraken-futures/)

Roq's Kraken futures gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-kraken-futures/).
