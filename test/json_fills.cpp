...
TEST(json_fills, simple) {
  ...
  EXPECT_EQ(obj.username, "bdb7a134-386a-45c0-b8e5-76a75537df4c"_sv);
  ...
  EXPECT_EQ(fill_0.order_id, "df2fa719-23bc-4cd7-8a84-5c3c41d75757"_sv);
  EXPECT_EQ(fill_0.cli_ord_id, "EwAF7gMAAQAAnNBFcdUQ"_sv);
  EXPECT_EQ(fill_0.fill_id, "21851c83-c490-40d0-8219-15f0c0c7a3cb"_sv);
