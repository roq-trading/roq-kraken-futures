...
protocol::json::OrderEventOrderType compute_order_type(
  ...
  switch (order_type) {
    ...
    case UNDEFINED:
      break;
    case MARKET:
      return protocol::json::OrderEventOrderType::MKT;
    case LIMIT:
      if (std::isnan(stop_price)) {
        return protocol::json::OrderEventOrderType::LMT;
      } else {
        return protocol::json::OrderEventOrderType::STP;
      }
      break;
  }
  throw RuntimeError{
